...
export const Drive = () => {
    return (
        <div className="bg-[#EFF8F6]">
            <h1 className="text-center text-4xl font-semibold p-4">Placement <span className="text-[#FF0000]">Drives</span></h1>
            <div className="flex flex-wrap gap-4 p-8 justify-evenly">
                ...
                <Card sx={{ maxWidth: 345, backgroundColor: "white" }} background-color="">
                    <CardMedia title="green iguana" />
                    <CardContent>
                        <Typography gutterBottom variant="h5" component="div">
                            Accenture
